...
Here the \texttt{s} parameter is the shape (currently, only \texttt{ellipse} and \texttt{triangle} are available) and the \texttt{d} parameter is the direction of the triangle.
